...
MINI_monkey::MINI_monkey()
{
	/* 초기화 */
	cnt = 0;

	/* 배경 설정 */
	SDL_Surface* temp_surface = IMG_Load("../../image/3-2_MINI_monkey_1.jpg");
...
/* 정답 입력 */
void MINI_monkey::print_eng(int word) {
	print_input = "_____";
	// 삭제라면
	if (word == '\b') {
		input[cnt] = NULL;
